...
\begin{enumerate}
	\item $a =  0.0006 \cm/\s^2$
	\item $d = 1.28\times 10^9 \cm \Rightarrow a = 3843.0664 \cm/\s^2$
	\item 
	\begin{enumerate}
		\item $M = 1.9\times 10^{33}  \g, \, d = 200 \cm, \, R = 1\times 10^7 \cm \Rightarrow a = 50692000.0000 \cm/\s^2$
		\item $\frac{a}{980} = 51726.5306$  Sí, esta es igual a 51726 veces la aceleración de la gravedad, y un ser humano sería destrozado y espaghettificado.
	\end{enumerate}
	\item $M = 1.9\times10^{41}, \, R = 2.95\times10^{13}	 \Rightarrow a = 0.0002 \cm/\s^2$
	\item En un agujero negro supermasivo, porque la fuerza de marea es mucho menor que la que un ser humano experimenta normalmente en la superficie de la Tierra. Esto plantea la cuestión de que, como viajero espacial, podrías encontrarte atrapado por un agujero negro supermasivo a menos que supieras exactamente cuál era su tamaño de antemano. No tendrías ninguna sensación física de haber cruzado el horizonte de sucesos del agujero negro antes de que fuera demasiado tarde.
\end{enumerate}
...
\begin{enumerate}
	\item Entropía de agujero negro: $3.05\times 10^{64}$
	\item Radiación gravitacional: $1.44\times 10^{-140}$
	\item Thomas-Fermi: $5.03\times 10^{-1}$
	\item Dispersión de Thompson: $6.65\times 10^{-25}$
	\item Límite de Stark: $2.73\times 10^{135}$
	\item Radiación de Bremstrahlung: $2.28\times 10^{16}$
	\item Fotoionización: $2.46\times 10^{-3}$
\end{enumerate}
