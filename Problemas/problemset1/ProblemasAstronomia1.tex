...
\begin{problema}
    ...
    \begin{enumerate}
        ...
        Para $M = 5.9\times 10^{21} g$ (masa de la tierra), $R=6.4\times 10^8 cm$ (radio de la tierra) y
        $G=6.67\times 10^{-8} \text{dinas } \text{cm}^2/\text{gm}^2$, calcula la aceleración de marea, $a$, 
        si una altura humana típica es $d=200cm$.
        \item ¿Cuál es la aceleración de marea a través del diámetro completo de la Tierra?
        \item Un agujero negro de masa estelar tiene la masa del sol $(1.9\times 10^{33}g)$, 
        y un radio de $2.9 km$.
        \begin{enumerate}
            \item A una distancia de $100km$, ¿cuál sería la aceleración de marea através de un humano para $d=200cm$
            \item Si la aceleraciòn de gravedad en la superficie de la tierra es $980 cm/s^2$, 
        ...
        ¿Cuál sería la aceleración de marea a través de un humano con $d=2m$, a una distancia de $100km$ desde el horizonte 
